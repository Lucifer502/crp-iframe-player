window.addEventListener('message', async e => {
  ...
  async function playerBeta() {
    ...
    const streamlist = response.streams.adaptive_hls;

    const search_lang = streamlist.user_lang ? user_lang : "";

    const stream = streamlist[search_lang].url;
  ...
  function startPlayer() {
    ...
    const openModal = () => modal.style.visibility = 'visible';
    ...
    playerInstance
      ...
      .addButton(download_iconPath, download_tooltipText, openModal, download_id);
